...
class GUI:
    def __init__(self, master):
        self.master = master
        self.master.title("Excel Splitter")
        ...
        self.num_splits_label = tk.Label(master, text="Number of Splits:")
        self.num_splits_label.grid(row=1, column=0, sticky=tk.E, padx=5, pady=(5,0))

        self.num_splits_var = tk.StringVar()
        self.num_splits_entry = ttk.Entry(master, textvariable=self.num_splits_var, width=30)
        self.num_splits_entry.grid(row=1, column=1, sticky=tk.W, padx=5, pady=(5,0))
    ...
    def generate_excel(self):
        ...
        num_splits = self.num_splits_var.get()
        ...
        if not num_splits.isdigit():
            self.set_processing_status("Please enter a valid number of splits.")
            return
        ...
        try:
            ...
            self.thread = threading.Thread(target=self.main_threaded, args=(input_file, num_splits))
    ...
    def main_threaded(self, input_file, num_splits):
        try:
